...
export async function POST(request: Request) {
  try {
    ...
    const folder = (formData.get('folder') as string) || 'partner-uploads';
    ...
    const filePath = `${folder}/${authResult.user?.id}/${fileName}`;
    ...
    console.error('POST /api/partner/upload error:', error);
    return NextResponse.json(
